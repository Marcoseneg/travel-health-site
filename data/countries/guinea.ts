...
// Sources: CDC Travelers' Health (Guinea) + CDC Yellow Book 2024;
// EKRM/HealthyTravel (https://www.healthytravel.ch); WHO. Framing reflects
// Swiss BAG schedule. Notable: yellow fever required for entry (proof of
// vaccination at Conakry airport from all countries); high chloroquine-
// resistant P. falciparum malaria year-round in all regions; meningitis-belt
// country (dry season Dec–Jun); Lassa fever and historical Ebola transmission.
export const guinea: CountryInfo = {
  ...
  countryAlerts: [
    {
      ...
      message:
        "Guinea requires proof of yellow fever vaccination for all arriving travelers aged 9 months and older — the certificate is checked at Ahmed Sékou Touré International Airport in Conakry. The vaccine must be given at least 10 days before arrival to be valid. Swiss travelers must receive it at an approved yellow fever vaccination center and carry the international certificate (carnet jaune).",
      source: "CDC Travelers' Health / WHO",
      sourceUrl: "https://wwwnc.cdc.gov/travel/destinations/traveler/none/guinea",
      date: "Updated 2026",
    },
    {
      level: "info",
      title: "Lassa fever and viral hemorrhagic fevers",
      message:
        "Lassa fever is endemic in Guinea (spread via contact with food or surfaces contaminated by infected rodents). Guinea also has a history of Ebola outbreaks. Avoid contact with rodents, sick people, and bushmeat. Standard travelers are at low risk; healthcare and aid workers should take specific precautions.",
      source: "EKRM / CDC",
  ...
  vaccinesDetail: [
    ...
    },
    {
      name: "Meningococcal",
      audience: "specific",
      note: "Guinea lies in the African meningitis belt. Quadrivalent (ACWY) vaccination is recommended for travel during the dry season (December–June), for longer stays, and for close contact with the local population.",
    },
    {
      name: "Cholera",
      audience: "specific",
  ...
  diseases: {
    malaria: {
      ...
      cdcMapUrl:
        "https://wwwnc.cdc.gov/travel/yellowbook/2024/preparing/yellow-fever-vaccine-malaria-prevention-by-country/guinea",
    },
    yellowFever: {
      riskSummary:
        "Guinea is in the yellow fever endemic zone, and vaccination is medically recommended for all travelers ≥9 months. It is also required for entry — proof is checked on arrival in Conakry. Vaccinate at least 10 days before travel and carry the international certificate.",
      keyFacts: [
    ...
    dengue: {
      riskSummary:
        "Dengue is present in Guinea, transmitted by daytime-biting Aedes mosquitoes. Risk is year-round in urban and rural areas. The same mosquito-bite prevention used for malaria also protects against dengue.",
      keyFacts: [
