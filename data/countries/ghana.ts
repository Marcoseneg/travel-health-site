...
// (seasonal meningococcal risk, dry season Dec–June); cholera transmission
// in several regions; active mpox (clade II) outbreak — CDC Level 2.
export const ghana: CountryInfo = {
  ...
  countryAlerts: [
    {
      ...
      source: "CDC / WHO IHR",
      sourceUrl: "https://wwwnc.cdc.gov/travel/destinations/traveler/none/ghana",
      date: "Updated 2026",
    },
    {
      level: "warning",
      title: "Mpox (clade II) outbreak — CDC Level 2",
      message:
  ...
  vaccinesDetail: [
    ...
    },
    {
      ...
      slug: "yellow-fever",
      audience: "all",
      note: "Required for entry AND recommended on health grounds for all travelers aged 9 months and older. Ghana is yellow-fever endemic. Administered at a designated Swiss yellow-fever vaccination centre; certificate valid 10 days after the dose and for life.",
    },
    {
      name: "Typhoid",
      slug: "typhoid",
    ...
    },
    {
      ...
      slug: "rabies",
      audience: "specific",
      note: "Rabid dogs are common in Ghana. Pre-exposure vaccination is recommended for long stays, rural or remote travel, cycling/motorbike trips, work with animals, and for children. Post-exposure care can be hard to access locally.",
    },
    {
      name: "Meningococcal",
      audience: "specific",
    ...
    },
    {
      name: "Cholera",
      audience: "specific",
      note: "Consider for higher-risk travelers given transmission in several regions (Ashanti, Central, Eastern, Greater Accra, Northern, Western) — aid/health workers or those in areas with active outbreaks or poor sanitation. Not needed for typical tourist itineraries.",
    },
  ],
  ...
  diseases: {
    malaria: {
      ...
      cdcMapUrl:
        "https://wwwnc.cdc.gov/travel/yellowbook/2024/preparing/yellow-fever-vaccine-malaria-prevention-by-country/ghana",
    },
    yellowFever: {
      riskSummary:
