...
export const qdengaRealWorldData: Insight = {
  id: "qdenga-real-world-data",
  date: "2026-05-02",
  title: "Qdenga real-world effectiveness and safety: new data",
  subtitle:
    "How the TAK-003 dengue vaccine is performing outside trials — and where it fits for travelers.",
