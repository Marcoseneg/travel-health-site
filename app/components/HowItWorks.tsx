...
const STEPS = [
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        <rect width="8" height="5" x="2" y="2" rx="1" /><path d="M6 12h12M6 16h12M6 20h12M2 12h.01M2 16h.01M2 20h.01" />
      </svg>
    ),
    title: "Prepare & go",
      ...
      <div style={{ maxWidth: "1320px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "16px" }}>
          {STEPS.map((item) => (
            ...
            >
              <div style={{
                position: "absolute", top: "16px", right: "20px", fontSize: "64px", fontWeight: 800,
                color: "rgba(255,255,255,0.02)", letterSpacing: "-0.04em", lineHeight: 1,
              }}>{item.step}</div>
              <div style={{
                width: "44px", height: "44px", borderRadius: "12px", display: "flex", alignItems: "center",
                justifyContent: "center", background: "rgba(56,189,248,0.08)", color: "#38bdf8", marginBottom: "20px",
              }}>{item.icon}</div>
              <h3 style={{ fontSize: "18px", fontWeight: 700, letterSpacing: "-0.02em", margin: "0 0 8px" }}>{item.title}</h3>
