    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className={`rounded-full ${risk.bg} ${risk.border} border px-4 py-2 text-sm font-semibold ${risk.text}`}>
            {risk.label}
          </div>
        </div>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <h3 className="text-lg font-semibold text-slate-900">Transmission</h3>
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            ...
            {disease.vaccineAvailable && (
              <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-sky-50 px-3 py-1 text-xs font-semibold text-sky-700 ring-1 ring-sky-200">
                💉 Vaccine available
              </div>
            )}
          </div>
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <h3 className="text-lg font-semibold text-slate-900">Treatment</h3>
            <p className="mt-3 text-sm leading-7 text-slate-600">
              {disease.treatment}
            </p>
          </div>
        ...
        <div className="mt-10 rounded-2xl bg-slate-100 p-5 text-xs leading-6 text-slate-500">
          <strong className="text-slate-600">Disclaimer:</strong> This
          information is for educational purposes only and does not replace
          professional medical advice. Consult a travel medicine specialist for
